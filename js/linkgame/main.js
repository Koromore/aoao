...
$.fn.gameLLK = function ($options) {
	...
	function picRandom() {
		...
		for (var i = 0; i <= picNum2; i++) {
			html1 += `
            <li data-roleid="${randomArr1[i]}">
                <img src="images/linkgame/role${randomArr1[i]}.jpg" alt="">
            </li>
            `
		}
		...
		for (var j = 0; j <= picNum2; j++) {
			html2 = `
            <li data-roleid="${randomArr2[j]}">
                <img src="images/linkgame/role${randomArr2[j]}.jpg" alt="">
            </li>
            `;
			if (j % 2 == 0) {
